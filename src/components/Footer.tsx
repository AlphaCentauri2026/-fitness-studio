        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-2xl font-bold mb-4">Fitness Studio</h3>
              <p className="text-gray-300 mb-4 max-w-md">
                Transform your body and mind with our expert trainers and state-of-the-art facilities.
                Join our community and become stronger every day.
              </p>
              <div className="space-y-2">
                <p className="text-gray-300">
                  <span className="font-semibold">Address:</span> 123 Fitness Street, Health City, HC 12345
                </p>
                <p className="text-gray-300">
                  <span className="font-semibold">Phone:</span> (555) 123-4567
                </p>
                <p className="text-gray-300">
                  <span className="font-semibold">Email:</span> info@fitnessstudio.com
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/trainers" className="text-gray-300 hover:text-white transition-colors">Trainers</a></li>
